function [expansionCoefficient,dictionaryIndex,weightVector,biasTerm,learningCurve,netSizeDiagram] = ...
    sparseKAPA2(K,trainInput,trainTarget,testInput,testTarget,paramRegularization,typeKernel,paramKernel,stepSizeFeatureVector,stepSizeWeightVector,stepSizeBias,toleranceDistance,tolerancePredictError,flagLearningCurve)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Function KAPA
