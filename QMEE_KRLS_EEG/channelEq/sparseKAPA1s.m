function [expansionCoefficient,dictionaryIndex,weightVector,biasTerm,learningCurve, netSizeDiagram] = ...
    sparseKAPA1s(K,trainInput,trainTarget,typeKernel,paramKernel,stepSizeFeatureVector,stepSizeWeightVector,stepSizeBias,toleranceDistance,tolerancePredictError,flagLearningCurve)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Function KAPA
