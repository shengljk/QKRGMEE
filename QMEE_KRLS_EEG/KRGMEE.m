function [expansionCoefficient,learningCurve,phi] = ...
    KRGMEE(K,trainInput,trainTarget,testInput,testTarget,typeKernel,paramKernel,regularizationFactor,forgettingFactor,flagLearningCurve,alpha_gmee,beta_gmee)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% KRLS based on MEE
% memeory initialization
% alpha_gmee = 1.5;           % alpha_gmee = 3，beta_gmee = 1.5  for Rayleigh noise
% beta_gmee = 3.8;          % alpha_gmee = 0.2，beta_gmee = 4  for mixed-Gaussian noise
...
for n = 2:K
    ...
    z_vector = Q_matrix*h_vector;
     for kk = 1:n
%         networkOutput(kk) = expansionCoefficient(ii)'* generalized_ker_eval(trainInput(:,kk),trainInput(:,ii),typeKernel,paramKernel,alpha_gmee,beta_gmee) ;
