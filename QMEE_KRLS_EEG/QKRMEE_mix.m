function [expansionCoefficient,learningCurve,phi] = ...
    QKRMEE_mix(K,trainInput,trainTarget,testInput,testTarget,typeKernel,paramKernel,regularizationFactor,forgettingFactor,flagLearningCurve,quan_thres,sigma)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% KRLS based on QGMEE
% memeory initialization
alpha_gmee = 2;           % alpha_gmee = 3，beta_gmee = 1.5  for Rayleigh noise
beta_gmee = 8;          % alpha_gmee = 0.2，beta_gmee = 4  for mixed-Gaussian noise
sigma = 1;
