...
[expansionCoefficientKrQgmee,learningCurveKrQgmee0,phi_QGMEE,gg_all0] = ...
    QKRGMEE(L0,trainInput,trainTarget,testInput,testTarget,typeKernel,paramKernel_KRQGMEE,regularizationFactorKrQgmee0,forgetting_QKRGMEE1,flagLearningCurve,alpha_QKRGMEE1,beta_QKRGMEE1,quan_QKRGMEE0);
toc;
...
[expansionCoefficientKrQgmee,learningCurveKrQgmee2,phi_QGMEE,gg_all2] = ...
    QKRGMEE(L2,trainInput,trainTarget,testInput,testTarget,typeKernel,paramKernel_KRQGMEE,regularizationFactorKrQgmee1,forgetting_QKRGMEE1,flagLearningCurve,alpha_QKRGMEE1,beta_QKRGMEE1,quan_QKRGMEE2);
toc;
%% QKRGMEE3
tic;
regularizationFactorKrQgmee3 = L1.^2 * 0.01 /2;
[expansionCoefficientKrQgmee,learningCurveKrQgmee3,phi_QGMEE,gg_all3] = ...
    QKRGMEE(L3,trainInput,trainTarget,testInput,testTarget,typeKernel,paramKernel_KRQGMEE,regularizationFactorKrQgmee1,forgetting_QKRGMEE1,flagLearningCurve,alpha_QKRGMEE1,beta_QKRGMEE1,quan_QKRGMEE3);

%% QKRGMEE4
regularizationFactorKrQgmee4 = L1.^2 * 0.01 /2;
[expansionCoefficientKrQgmee,learningCurveKrQgmee4,phi_QGMEE,gg_all4] = ...
    QKRGMEE(L4,trainInput,trainTarget,testInput,testTarget,typeKernel,paramKernel_KRQGMEE,regularizationFactorKrQgmee1,forgetting_QKRGMEE1,flagLearningCurve,alpha_QKRGMEE1,beta_QKRGMEE1,quan_QKRGMEE4);
toc;
...
[expansionCoefficientKrQgmee,learningCurveKrQgmee5,phi_QGMEE,gg_all5] = ...
    QKRGMEE(L5,trainInput,trainTarget,testInput,testTarget,typeKernel,paramKernel_KRQGMEE,regularizationFactorKrQgmee1,forgetting_QKRGMEE1,flagLearningCurve,alpha_QKRGMEE1,beta_QKRGMEE1,quan_QKRGMEE5);
toc;
