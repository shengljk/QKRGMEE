...
% regularizationFactorKrmee = 0.2;
forgettingFactorKrQgmee = 1;

paramKernel_MCC = 1;
% flagLearningCurve = 1;
[expansionCoefficientKrQgmee,learningCurveKrQgmee,phi_QGMEE] = ...
    KRQGMEE(L,trainInput,trainTarget,testInput,testTarget,typeKernel,paramKernel_KRQGMEE,regularizationFactorKrQgmee,forgettingFactorKrQgmee,flagLearningCurve);
% % =========end of KRLSGMEE================
...
legend('KLMS','KRLS','KRMC','KRMEE','KRGMEE','KRQGMEE')
