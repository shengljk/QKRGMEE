...
%% 可调参数
% 公用参数
L1 = 5;                     % for MEE QMEE GMEE QGMEE
L2 = 10;                     % for MEE QMEE GMEE QGMEE
L3 = 50;                     % for MEE QMEE GMEE QGMEE
L4 = 80;                     % for MEE QMEE GMEE QGMEE
L5 = 100;                     % for MEE QMEE GMEE QGMEE
...
[expansionCoefficientKrQgmee,learningCurveKrQgmee2,phi_QGMEE] = ...
    QKRGMEE(L2,trainInput,trainTarget,testInput,testTarget,typeKernel,paramKernel_KRQGMEE,regularizationFactorKrQgmee1,forgetting_QKRGMEE1,flagLearningCurve,alpha_QKRGMEE1,beta_QKRGMEE1,quan_QKRGMEE1);

%% QKRGMEE3
regularizationFactorKrQgmee3 = L1.^2 * 0.01 /2;
[expansionCoefficientKrQgmee,learningCurveKrQgmee3,phi_QGMEE] = ...
    QKRGMEE(L3,trainInput,trainTarget,testInput,testTarget,typeKernel,paramKernel_KRQGMEE,regularizationFactorKrQgmee1,forgetting_QKRGMEE1,flagLearningCurve,alpha_QKRGMEE1,beta_QKRGMEE1,quan_QKRGMEE1);

%% QKRGMEE4
regularizationFactorKrQgmee4 = L1.^2 * 0.01 /2;
[expansionCoefficientKrQgmee,learningCurveKrQgmee4,phi_QGMEE] = ...
    QKRGMEE(L4,trainInput,trainTarget,testInput,testTarget,typeKernel,paramKernel_KRQGMEE,regularizationFactorKrQgmee1,forgetting_QKRGMEE1,flagLearningCurve,alpha_QKRGMEE1,beta_QKRGMEE1,quan_QKRGMEE1);

%% QKRGMEE5
regularizationFactorKrQgmee5 = L1.^2 * 0.01 /2;
[expansionCoefficientKrQgmee,learningCurveKrQgmee5,phi_QGMEE] = ...
    QKRGMEE(L5,trainInput,trainTarget,testInput,testTarget,typeKernel,paramKernel_KRQGMEE,regularizationFactorKrQgmee1,forgetting_QKRGMEE1,flagLearningCurve,alpha_QKRGMEE1,beta_QKRGMEE1,quan_QKRGMEE1);
...
legend('KRLS','KRQGMEE(L=5, \alpha=0.8, \beta=3.8, \gamma=0.02)','KRQGMEE(L=15, \alpha=0.8, \beta=3.8, \gamma=0.02)','KRQGMEE(L=20, \alpha=0.8, \beta=3.8, \gamma=0.02)','KRQGMEE(L=40, \alpha=0.8, \beta=3.8, \gamma=0.02)','KRQGMEE(L=80, \alpha=0.8, \beta=3.8, \gamma=0.02)');
