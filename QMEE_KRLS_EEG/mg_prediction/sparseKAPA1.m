function [expansionCoefficient,dictionaryIndex,weightVector,biasTerm,learningCurve] = ...
    sparseKAPA1(K,trainInput,trainTarget,testInput,testTarget,typeKernel,paramKernel,stepSizeFeatureVector,stepSizeWeightVector,stepSizeBias,toleranceDistance,tolerancePredictError,flagLearningCurve)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Function KAPA
...
% keep the first input in the dictionary blindly
...
for n = 2:trainSize
    ...
    if dictSize < K
        ...
        expansionCoefficient(dictSize-K+1:dictSize) = expansionCoefficient(dictSize-K+1:dictSize) + stepSizeFeatureVector*aprioriErr';
    end
