...
[expansionCoefficientQKRMEE,learningCurveQKRMEE,phi_QKRMEE] = ...
    QKRMEE_Ray(L,trainInput,trainTarget,testInput,testTarget,typeKernel,paramKernel_QKRMEE,regularizationFactorQKRMEE,forgetting_QKRMEE,flagLearningCurve,quan_thres_QKRMEE,sigma_QKRMEE);
...
legend('KRLS','KRMC','KRMEE','KRQMEE','KRGMEE','KRQGMEE')
