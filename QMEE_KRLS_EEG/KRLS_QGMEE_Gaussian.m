...
[expansionCoefficientKrmee,learningCurveKrmee,phi] = ...
    KRMEE(L,trainInput,trainTarget,testInput,testTarget,typeKernel,paramKernel_KRMEE,regularizationFactorKrmee,forgettingFactorKrmee,flagLearningCurve,sigma_KRMEE);
% % =========end of KRMEE================
