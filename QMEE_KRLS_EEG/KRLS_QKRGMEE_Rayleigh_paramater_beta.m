...
[expansionCoefficientKrQgmee,learningCurveKrQgmee2,phi_QGMEE] = ...
    QKRGMEE(L2,trainInput,trainTarget,testInput,testTarget,typeKernel,paramKernel_KRQGMEE,regularizationFactorKrQgmee1,forgetting_QKRGMEE1,flagLearningCurve,alpha_QKRGMEE2,beta_QKRGMEE2,quan_QKRGMEE1);

%% QKRGMEE3
regularizationFactorKrQgmee3 = L1.^2 * 0.01 /2;
[expansionCoefficientKrQgmee,learningCurveKrQgmee3,phi_QGMEE] = ...
    QKRGMEE(L3,trainInput,trainTarget,testInput,testTarget,typeKernel,paramKernel_KRQGMEE,regularizationFactorKrQgmee1,forgetting_QKRGMEE1,flagLearningCurve,alpha_QKRGMEE3,beta_QKRGMEE3,quan_QKRGMEE1);

%% QKRGMEE4
regularizationFactorKrQgmee4 = L1.^2 * 0.01 /2;
[expansionCoefficientKrQgmee,learningCurveKrQgmee4,phi_QGMEE] = ...
    QKRGMEE(L4,trainInput,trainTarget,testInput,testTarget,typeKernel,paramKernel_KRQGMEE,regularizationFactorKrQgmee1,forgetting_QKRGMEE1,flagLearningCurve,alpha_QKRGMEE4,beta_QKRGMEE4,quan_QKRGMEE1);

%% QKRGMEE5
regularizationFactorKrQgmee5 = L1.^2 * 0.01 /2;
[expansionCoefficientKrQgmee,learningCurveKrQgmee5,phi_QGMEE] = ...
    QKRGMEE(L5,trainInput,trainTarget,testInput,testTarget,typeKernel,paramKernel_KRQGMEE,regularizationFactorKrQgmee1,forgetting_QKRGMEE1,flagLearningCurve,alpha_QKRGMEE5,beta_QKRGMEE5,quan_QKRGMEE1);
...
legend('KRLS','KRQGMEE(L=40, \alpha=0.8, \beta=0.5, \gamma=0.02)','KRQGMEE(L=40, \alpha=0.8, \beta=2, \gamma=0.02)','KRQGMEE(L=40, \alpha=0.8, \beta=3.8, \gamma=0.02)','KRQGMEE(L=40, \alpha=0.8, \beta=15, \gamma=0.02)','KRQGMEE(L=40, \alpha=0.8, \beta=30, \gamma=0.02)');
