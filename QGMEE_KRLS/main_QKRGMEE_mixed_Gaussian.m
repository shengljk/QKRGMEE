...
[expansionCoefficientKRGMEE,learningCurveKRGMEE,phi] = ...
    KRGMEE(L,trainInput,trainTarget,testInput,testTarget,typeKernel,paramKernel_KRGMEE,regularizationFactorKRGMEE,forgettingFactorKRGMEE,flagLearningCurve,paramKernel_MCC);
...
plot(10*log10(ensembleLearningCurveKrmc'),'r','LineWidth',2)
plot(10*log10(ensembleLearningCurveKmc'),'b','LineWidth',2)
plot(10*log10(ensembleLearningCurveKMMCC'),'c','LineWidth',2)
plot(10*log10(ensembleLearningCurveKrmee'),'LineWidth',2)
plot(10*log10(ensembleLearningCurveKRGMEE'),'k','LineWidth',2)

legend('KLMS','KRLS','KRMC','KMC','KMMCC','KRMEE','KRGMEE')
